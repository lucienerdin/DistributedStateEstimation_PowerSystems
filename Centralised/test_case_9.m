...
real_solution = runpf('case9'); %replace with mpc
...
plac_cent.idx_zPF = [1;2;3;4;5;6;7;8;9]; %index of branch
plac_cent.idx_zPT = [1;2;3;4;5;6;7;8;9]; %index of branch
plac_cent.idx_zPG = [1;2;3]; %index of generator
plac_cent.idx_zVa = []; %index of bus
plac_cent.idx_zQF = [1;2;3;4;5;6;7;8;9]; %index of branch
plac_cent.idx_zQT = [1;2;3;4;5;6;7;8;9]; %index of branch
plac_cent.idx_zQG = [1;2;3]; %index of generator
plac_cent.idx_zVm = [1;2;3;4;5;7;8;9]; %index of bus
...
title('Norm of G matrix at each iteration in matpower 9 bus system')
...
title('Voltage error at bus 2 in matpower 9 bus system')
xlabel('Iteration count of state estimation')
...
title('Anlge error at bus 2 in matpower 9 bus system')
xlabel('Iteration count of state estimation')
...
title('Anlge error at all busses in matpower 9 bus system. Run 50 SE with different noises')
xlabel('Angle error in radians')
ylabel('Counts')

figure(5)
histogram(voltageerror);
title('Voltage error at all busses in matpower 9 bus system. Run 50 SE with different noises')
xlabel('Voltage error in p.u.')
ylabel('Counts')

figure(6)
histogram(iterations);
title('Number of iterations needed to converge in matpower 9 bus system. Run 50 SE with different noises')
